...
(deflayer qwerty
  ...
  services.gvfs.enable = true; # <- Enable GVFS for using Trash.
  ...
  nix.settings = {
    ...
    substituters = [ "https://mirror.sjtu.edu.cn/nix-channels/store/" "https://nix-community.cachix.org" "https://chaotic-nyx.cachix.org" "https://cosmic.cachix.org" "https://mirrors.tuna.tsinghua.edu.cn/nix-channels/store/" ];
